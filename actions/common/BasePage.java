...
public class BasePage {
	...
	public void getTextElement(WebDriver driver, String xpathLocator) {
	...
	public void getSelectedItemCustomDropdown(WebDriver driver, String xpathLocator, String parentXpath,
			String childXpath, String expectedItem) {
		clickElement(driver, xpathLocator);
		sleepInSecond(1);
	...
	public String getElementProperties(WebDriver driver, String xpathLocator, String propertyName) {
	...
	public boolean isElementEnabe(WebDriver driver, String xpathLocator) {
