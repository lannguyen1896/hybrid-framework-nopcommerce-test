...
public class RegisterPageUI {
 public static final String FIRST_NAME_TETXBOX= "xpath=//input[@id='FirstName']";
 ...
 public static final String CONFIRMP_PASSWORD_ERROR_MESSAGE= "xpath=//span[@id='ConfirmPassword-error']";
