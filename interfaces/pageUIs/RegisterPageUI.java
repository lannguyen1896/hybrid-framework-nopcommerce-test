...
public class RegisterPageUI {
 public static final String FIRST_NAME_TETXBOX= "//input[@id='FirstName']";
 ...
 public static final String CONFIRMP_PASSWORD_ERROR_MESSAGE= "//span[@id='ConfirmPassword-error']";
